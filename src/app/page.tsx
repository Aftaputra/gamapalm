...
// PERUBAHAN: Navbar disederhanakan agar lebih rapi dan solid + tombol Sign Up
const Navbar = () => (
  <header className="fixed top-0 left-0 w-full z-30 bg-white shadow-md">
    <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center py-3">
      ...
      <nav className="flex items-center gap-3 sm:gap-4">
        <Link href="/signup" className="text-sm font-medium px-4 py-2 rounded-lg border border-blue-600 text-blue-600 hover:bg-blue-50 transition-colors">
          Sign Up
        </Link>
...
const HeroSection = () => (
  <section className="relative h-screen flex items-center justify-center text-white pt-16">
    ...
    <div className="relative z-20 text-center max-w-3xl mx-auto px-4">
      ...
      {/* PERUBAHAN: CTA diarahkan ke halaman signup */}
      <Link href="/signup" className="mt-10 inline-flex items-center gap-3 px-8 py-4 bg-blue-600 text-white font-semibold rounded-lg shadow-lg hover:bg-blue-700 transition-transform hover:scale-105">
