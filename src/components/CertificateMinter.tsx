...
import { User, FileCode, Copy, Check, Loader2, Sparkles, AlertTriangle, Award } from 'lucide-react';
...
export default function CertificateMinter() {
    ...
    const handleMint = async () => {
        ...
        try {
            ...
            const metadata = {
                name: 'Sertifikat ISPO', // FIX: Nama NFT disesuaikan
    ...
    return (
        <div className="w-full max-w-lg p-8 border rounded-xl shadow-lg bg-white transition-all">
            <div className="text-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-800">Terbitkan Sertifikat ISPO</h2>
            ...
            <div className="flex flex-col gap-5">
                <div className="relative">
                    ...
                    <input 
                        ...
                        className="w-full pl-10 pr-3 py-2.5 border rounded-lg text-gray-800 focus:ring-2 focus:ring-slate-500 focus:border-slate-500 transition-colors"
                    />
                </div>
                <div className="relative">
                    <FileCode className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-800" />
                    <input 
                        type="text" 
            ...
            <button
                onClick={handleMint}
                disabled={isMinting}
                className="w-full flex items-center justify-center gap-2 py-3 mt-6 bg-slate-800 hover:bg-slate-900 disabled:bg-slate-400 text-white rounded-lg font-semibold transition-colors text-base shadow-md"
            >
                {isMinting ? (
                    <>
